...
#传入饼干的三种方式：
#
# 环境变量：。export COOKIE_FILE=/path/to/cookies.json
#
# 在参数中指定路径，如下所示：cookies.jsoncookiePath
#
# bot = Chatbot(cookiePath='./cookie.json')
# 直接通过参数传入 cookie ，如下所示：cookies
#
